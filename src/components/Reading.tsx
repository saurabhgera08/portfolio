...
const shapingBooks = [{
  ...
  author: "Phil Knight",
  image: "/placeholder.svg",
  about: "Phil Knight's autobiography of building Nike from a mad idea to a global empire. It's raw about the struggle, the near-death experiences, the irrational bets, and the people who believed when belief made no sense.",
  why: "This book isn't about business. It's about obsession, stupidity, courage, and what happens when someone refuses to give up despite every rational reason to quit. Knight writes: \"It seems wrong to call it business. It seems wrong to throw all those hectic days and sleepless nights, all those magnificent triumphs and desperate struggles, under that bland, generic banner: business. For some, I realize, business is the all-out pursuit of profits, period, full stop, but for us business was no more about making money than being human is about making blood.\"",
  impact: "This is how I think about building. It's not about optimization or quarterly metrics. It's about creating something that didn't exist before. Business is the vehicle, but the goal is transformation. When I faced the decision to exit SWNCK, I thought about Knight's journey. He had multiple moments where quitting made sense. He didn't quit because he understood something: the journey itself was the education. I learned from that. Some exits are failures. Some are clarity."
}, {
  title: "Steve Jobs",
  ...
  return <section id="reading" className="py-24 sm:py-36 md:py-48 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-24 sm:mb-28 max-w-4xl mx-auto">
          <h3 className="text-3xl sm:text-4xl font-bold text-foreground mb-8 text-center">How I Think About Reading</h3>
          <div className="space-y-4 text-foreground/80 leading-relaxed">
            <p>
              I read to understand the world and widen the horizons of my thinking. I'm drawn to books that challenge my assumptions, show me new domains I know nothing about, or reveal how extraordinary people approached seemingly impossible problems.
            </p>
            <p>
